...
class PartialClientTrainer(Executor):
    ...
    def execute(self, task_name: str, shareable: Shareable, fl_ctx: FLContext, abort_signal: Signal) -> Shareable:
        ...
        try:
            ...
            state_file = f"/files/jetson_impl/fedavg_aggregation/fl_adaptive_freeze/temp/{self.save_file_aux}_{fl_ctx.get_identity_name()}_state.pkl"
        ...
        try:
            ...
            if current_round == 0:
                ...
                for gl_exp in converged_experts:
                    layer_idx=gl_exp//64
                    exp_idx=gl_exp%64
